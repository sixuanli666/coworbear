...
img_dir = r"D:\projects\权益投资部模型库\分数\单因子图输出"
...
with st.sidebar:
    ...
    out_file_path = st.text_input(
        ...
        value="D:/projects/权益投资部模型库/1.1 权重结果_2002_2025.csv",
        key="div_path"
    )
    # 时间范围（默认自动根据CSV）
...
with st.sidebar:
    ...
    base_dir = st.text_input("CSV 目录", value="D:/projects/权益投资部模型库/", key="rot_dir")
    path_daily   = st.text_input("日度CSV", value=base_dir + "2.1 大小盘轮动_日度价差与净值.csv", key="rot_path_daily")
    path_monthly = st.text_input("月度CSV", value=base_dir + "2.1 大小盘轮动_月度收益与净值.csv", key="rot_path_month")
    path_quarter = st.text_input("季度CSV", value=base_dir + "2.1 大小盘轮动_季度收益与净值.csv", key="rot_path_quarter")
...
# 线下输出产物路径（保持你原来的路径）
img_path_industry = r"D:/projects/权益投资部模型库/2.2 行业拥挤度_图1.png"
img_path_tmt = r"D:/projects/权益投资部模型库/2.2 TMT行业拥挤度_图2.png"
xlsx_path_table = r"D:/projects/权益投资部模型库/2.2_行业周度概览.xlsx"
...
with st.sidebar:
    ...
    base_dir_31 = st.text_input("结果目录", value="D:/projects/权益投资部模型库", key="std31_base")
    csv_path_31 = st.text_input("全量CSV路径", value=base_dir_31 + "/3.1 turn_daily_std_全量.csv", key="std31_csv")
